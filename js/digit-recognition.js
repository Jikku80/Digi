...
var canvasBackgroundColor 	= "#2c2c2c";
var canvasId              	= "canvas";
	...
	chart = new Chart(ctx, {
	    ...
	    data: {
	        ...
	        datasets: [{
	            ...
	            backgroundColor: 'rgb(26, 184, 150)',
	            borderColor: 'rgb(26, 184, 150)',
	            data: data,
	        }]
	    },
...
let nav_help = document.querySelector(".nav_help");
let modalhelp = document.querySelector(".help");
